sap.ui.define([
	...
	return BaseController.extend("com.limscloud.app.controller.jobs.ApproveReview", {
		formatter: formatter,
		onInit: function () {
			this.router = this.getOwnerComponent().getRouter();
			var route = sap.ui.core.UIComponent.getRouterFor(this).getRoute("RD50");
			route.attachPatternMatched(this.onPatternMatched, this);

		},
		onPatternMatched: function (oEvent) {
			console.log("I'm at RD50 - Approve Review")
			var that = this;
